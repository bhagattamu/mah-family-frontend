...
@Component({
    selector: 'app-edit-timeline-point',
    template: `
...
export class EditTimelinePointComponent implements OnInit {
    ...
    constructor(private activatedRoute: ActivatedRoute, private readonly projectService: ProjectService) {
        ...
        this.timelinePoint = this.activatedRoute.snapshot.queryParams.timelinePoint;
    }
    ngOnInit(): void {
