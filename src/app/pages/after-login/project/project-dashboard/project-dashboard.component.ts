...
import { LoaderService, ProjectService } from 'src/app/@core/services';
...
export class ProjectDashboardComponent implements OnInit {
    ...
    constructor(private readonly router: Router, private readonly projectService: ProjectService, private readonly authService: AuthService, private dialogService: NbDialogService, public loaderService: LoaderService) {}
